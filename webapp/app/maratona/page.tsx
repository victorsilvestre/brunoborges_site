...
export const metadata: Metadata = {
    ...
    description: 'Participe da 14ª Maratona TDS Trader de Sucesso. Evento 100% online e gratuito. Aprenda Price Action, Gerenciamento e Estratégias diretamente no gráfico.',
};
