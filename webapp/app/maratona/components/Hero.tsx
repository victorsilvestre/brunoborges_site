...
export function Hero() {
    return (
        <section className="relative min-h-[95vh] lg:min-h-screen flex items-center overflow-hidden pt-20 bg-[#f8fafc]">
            {/* Light Background Pattern */}
            <div className="absolute inset-0 z-0">
                <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808008_1px,transparent_1px),linear-gradient(to_bottom,#80808008_1px,transparent_1px)] bg-[size:32px_32px]"></div>
                <div className="absolute right-0 top-0 -z-10 h-[500px] w-[500px] rounded-full bg-red-400 opacity-10 blur-[120px]"></div>
                <div className="absolute left-1/4 bottom-0 -z-10 h-[400px] w-[400px] rounded-full bg-orange-400 opacity-10 blur-[100px]"></div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 w-full mb-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="max-w-xl">
                        <FadeIn>
                            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-lg border border-red-200 bg-red-50 text-red-600 mb-8">
                        ...
                        <FadeIn delay={0.1}>
                            <h1 className="font-display font-black text-5xl md:text-6xl lg:text-[70px] leading-[1.05] tracking-tight mb-6 text-slate-800">
                                Participe da 14ª <br />
                                <span className="text-slate-700">Maratona</span>{" "}
                                <span className="text-red-500 block italic">Trader de Sucesso</span>
                            </h1>
                        </FadeIn>

                        <FadeIn delay={0.2}>
                            <p className="text-lg md:text-xl text-slate-600 mb-8 leading-relaxed max-w-[480px]">
                        ...
                        <FadeIn delay={0.25}>
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 mb-10">
                                <div className="inline-flex items-center gap-3 px-5 py-3 rounded-lg bg-white shadow-sm border border-slate-200">
                                    ...
                                    <span className="text-sm font-bold tracking-wider text-slate-700">31/03 a 02/04/26</span>
                                </div>
                                <div className="inline-flex items-center gap-3 px-5 py-3 rounded-lg bg-white shadow-sm border border-slate-200">
                                    <span className="text-sm font-bold tracking-wider text-slate-700">100% Online e Gratuito</span>
                                </div>
                            </div>
                        </FadeIn>
                        ...
                        <FadeIn delay={0.4}>
                            <div className="flex flex-col sm:flex-row gap-6 items-center">
                                <a href="https://t.me/+7OFz4IzbCLQ5MDhh" target="_blank" rel="noopener noreferrer" className="bg-red-500 hover:bg-red-600 text-white py-4 px-8 text-lg w-full sm:w-auto flex items-center justify-center rounded-xl transition-all shadow-[0_8px_20px_rgba(239,68,68,0.3)] hover:shadow-[0_12px_25px_rgba(239,68,68,0.4)] hover:-translate-y-1">
                        ...
                        <FadeIn delay={0.6} className="relative w-full max-w-lg">
                            ...
                            >
                                <div className="flex justify-between items-start mb-2">
                                    <span className="text-xs font-medium text-slate-500">Assertividade</span>
                                    <span className="text-xs font-bold text-emerald-600 flex items-center">
                                        <TrendingUp className="w-3 h-3 mr-1" /> +90%
                                    </span>
                                </div>
                                <div className="text-3xl font-black text-slate-800">92,5%</div>
                                <div className="text-xs text-slate-400 mt-1">No último mês</div>
                            </motion.div>
                            ...
                            >
                                <div className="flex justify-between w-full text-slate-500 text-xs font-medium mb-4">
                                    <span>Gerenciamento</span>
                                    <span className="text-emerald-500 flex items-center"><TrendingUp className="w-3 h-3 mr-1" />90%</span>
                                </div>
                                <div className="relative w-24 h-24">
                                    <svg viewBox="0 0 36 36" className="w-24 h-24 text-green-400 max-w-full">
                                        <path
                            ...
                            <div className="absolute -right-16 md:-right-24 top-1/4 bg-white rounded-2xl p-2 shadow-lg border border-slate-100 hidden lg:flex flex-col gap-4 z-10">
                                <div className="p-3 bg-red-50 text-red-500 rounded-xl"><Target className="w-5 h-5" /></div>
                                <div className="p-3 text-slate-400 hover:text-red-500 transition-colors"><TrendingUp className="w-5 h-5" /></div>
                                <div className="p-3 text-slate-400 hover:text-red-500 transition-colors"><Calendar className="w-5 h-5" /></div>
                            </div>
                        </FadeIn>
                    </div>
                </div>
