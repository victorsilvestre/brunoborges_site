                    ...
                    <div className="max-w-xl">
                        ...
                        <FadeIn delay={0.1}>
                            <h3 className="font-display font-black text-4xl md:text-6xl text-[var(--dark-pure)] uppercase leading-[0.9] tracking-tighter">
                                Quem já <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--dark-pure)] to-[var(--gold-premium)]">Participou Aprova!</span>
                            </h3>
                        </FadeIn>
                    </div>
                </div>
                ...
                <FadeIn delay={0.3}>
                    ...
                    >
                        {testimonials.map((t, idx) => (
                            <div
                                key={idx}
                                className="w-[85vw] sm:w-[400px] shrink-0 snap-center sm:snap-start flex flex-col justify-between p-8 sm:p-10 rounded-[2rem] border border-slate-200 bg-white shadow-sm hover:border-[var(--gold-premium)]/40 transition-colors h-auto min-h-[400px]"
                            >
                                <div
