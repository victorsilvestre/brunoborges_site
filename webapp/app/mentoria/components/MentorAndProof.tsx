...
export function MentorAndProof() {
    return (
        <section className="w-full bg-[var(--m-subtle)] border-b border-[var(--m-border)] py-16 lg:py-24" id="mentor">
                ...
                <div>
                    <div className="max-w-3xl mb-10">
                        ...
                        <h3 className="font-[family-name:var(--m-font-display)] text-3xl sm:text-4xl lg:text-5xl text-[var(--m-dark)] font-bold tracking-tight">
                            Quem viveu a Mentoria conta melhor do que a gente.
                        </h3>
                        <p className="mt-3 text-base sm:text-lg text-[var(--m-body)] leading-relaxed">
                            Veja como traders comuns transformaram a incerteza do gráfico em leitura sólida, autonomia e execução controlada após vivenciarem os 60 dias da TDS.
                        </p>
                    </div>
