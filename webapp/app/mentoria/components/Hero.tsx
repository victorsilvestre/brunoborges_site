      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between pb-4 mb-8 border-b border-[var(--m-border)] gap-3 text-xs font-[family-name:var(--m-font-mono)]">
          <div className="inline-flex items-center gap-2">
            <span className="px-2 py-0.5 bg-[var(--m-bull-bg)] border border-[var(--m-bull-border)] text-[var(--m-bull)] font-bold rounded">
              Inscrições Abertas
            </span>
            <span className="uppercase tracking-wide text-[var(--m-dark)] font-bold">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            <h1 className="font-[family-name:var(--m-font-display)] text-4xl sm:text-5xl lg:text-[56px] leading-[1.08] text-[var(--m-dark)] font-bold tracking-tight mb-6">
              Pare de tentar adivinhar o lado do mercado.{" "}
              <span className="text-[var(--m-bull)] bg-[var(--m-bull-bg)] px-2 py-0.5 rounded border border-[var(--m-bull-border)] inline-block">
                Aprenda a ler o que o gráfico está mostrando.
              </span>
            </h1>

            <p className="text-base sm:text-lg text-[var(--m-body)] leading-relaxed mb-4 sm:mb-8 pl-4 border-l-2 border-[var(--m-bull)]">
              Uma mentoria ao vivo de Price Action para quem quer construir uma
              leitura própria do mercado, entender o comportamento do preço e
              desenvolver um operacional com um método que já formou mais de
              1.400 Traders De Sucesso.
            </p>
            ...
            <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-1.5 sm:gap-3 py-1.5 sm:py-4 border-y border-[var(--m-border)] mb-4 sm:mb-8 bg-[var(--m-subtle)] rounded-lg">
              <div className="p-1.5 sm:p-3 border-r border-[var(--m-border)]">
                <div className="flex items-center gap-1.5 text-[var(--m-bull)] mb-0.5 sm:mb-1">
                  ...
                  <span className="text-[9px] sm:text-[10px] font-[family-name:var(--m-font-mono)] text-[var(--m-caption)]">
                    DURAÇÃO
                  </span>
                </div>
                <div className="font-[family-name:var(--m-font-mono)] text-[11px] sm:text-xs uppercase tracking-tight text-[var(--m-dark)] font-bold">
                  60 dias de mentoria
                </div>
              </div>
          ...
          <div className="lg:col-span-5 w-full">
            <div className="bg-white border border-[var(--m-border)] rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-0 bg-white border-t border-[var(--m-border)] divide-x divide-[var(--m-border)] text-center">
                <div className="p-4">
                  <div className="font-[family-name:var(--m-font-mono)] text-[9px] text-[var(--m-caption)] uppercase font-semibold">
                    ALUNOS FORMADOS
                  </div>
                  <div className="font-[family-name:var(--m-font-display)] text-2xl font-bold text-[var(--m-bull)] mt-0.5 tabular-nums">
                    +1.400
                  </div>
                </div>
                <div className="p-4">
                  ...
                  <div className="font-[family-name:var(--m-font-display)] text-2xl font-bold text-[var(--m-dark)] mt-0.5">
                    7+ ANOS
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 font-[family-name:var(--m-font-mono)] text-xs text-[var(--m-caption)] bg-[var(--m-subtle)] px-4 py-3 border-t border-[var(--m-border)]">
                ...
                <span>
                  Próxima turma com vagas limitadas. Inscrições abertas até{" "}
                  <strong className="text-[var(--m-dark)] font-bold">
                    29/09/26
                  </strong>{" "}
