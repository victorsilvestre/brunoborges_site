    ...
    <section className="relative py-32 lg:py-40 bg-black overflow-hidden border-t border-[var(--white-10)]">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          ...
          <FadeIn delay={0.2}>
            <p className="text-xl lg:text-2xl text-[var(--white-40)] font-light leading-relaxed max-w-3xl mx-auto">
              Enquanto todo o mundo dorme, os comprometidos{" "}
        ...
        {/* Main Content Grid */}
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-0">
          {/* Left: Time Display */}
          <FadeIn delay={0.3}>
            <div className="relative">
              ...
              <div className="mt-8 text-center lg:text-left">
                <p className="text-lg italic text-[var(--white-60)] border-l-4 border-[var(--green-bull)] pl-6 py-2">
                  Durante anos, 5h da manhã era o único horário que eu tinha
                  para estudar, fazer backteste e treinar o meu operacional. Não
                  porque era o horário ideal — longe disso.
                  <br />
                  <br />
                  Abri mão de muitas coisas para conseguir "ter" esse tempo.
                  Simplesmente porque era o único momento possível, sem impactar
                  o meu trabalho ou a minha família. Hoje, vejo que foram esses
                  estudos que construíram a minha base no mercado.
                  <br />
                  <br />
                  Querendo ajudar e transformar a vida de outras pessoas,
                  resolvi ensinar gratuitamente meus inscritos do YouTube. Todos
                  os domingos, às 5h da manhã, nós tínhamos um encontro marcado
                  — com o único objetivo de aprender. Com o tempo, esse apelido
                  informal ganhou força.
                  <br />
                  <br />
                  A verdade é que evolução não depende de tempo livre.
                  <br />
                  Depende de{" "}
            ...
            <FadeIn delay={0.4}>
              <div className="bg-[var(--dark-surface)] border border-[var(--white-10)] rounded-2xl p-8 hover:border-[var(--green-bull)]/30 transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-display font-bold text-xl uppercase text-white mb-0">
                      Disciplina Real
                    </h3>
                    <p className="text-[var(--white-60)] leading-relaxed">
                      Day Trade não é sobre operar mais. É sobre operar no
                      momento certo. Se você não consegue explicar o contexto da
                      entrada, você não deveria estar nela. Antes de clicar,
                      responda: "O que o mercado está tentando me mostrar aqui?"
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[var(--dark-surface)] border border-[var(--white-10)] rounded-2xl p-8 hover:border-[var(--green-bull)]/30 transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--white-60)] leading-relaxed">
                      Você não evolui só operando. Você evolui analisando o que
                      fez. Depois de cada operação, revise: qual era o contexto,
                      porque você entrou, o que o mercado deveria fazer e o que
                      o mercado não poderia fazer.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[var(--dark-surface)] border border-[var(--white-10)] rounded-2xl p-8 hover:border-[var(--green-bull)]/30 transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--white-60)] leading-relaxed">
                      O mercado nunca está errado, mas a sua leitura pode estar. 
                      Pare de avaliar o resultado e comece a avaliar as suas decisões. 
                      Decisões corretas que vão garantir a sua sobrevivência no mercado.
                    </p>
                  </div>
                </div>
              </div>
