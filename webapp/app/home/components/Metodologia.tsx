    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-[var(--gold-premium)]/4 blur-[120px] rounded-full" />
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="text-center max-w-4xl mx-auto mb-28">
                    <FadeIn>
                        <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full border border-[var(--gold-premium)]/30 bg-[var(--gold-premium)]/10 backdrop-blur-md mb-8">
                            <BookOpen className="w-4 h-4 text-[var(--gold-premium)]" />
                    ...
                    <FadeIn delay={0.2}>
                        <p className="text-xl lg:text-2xl text-[var(--white-40)] font-light leading-relaxed">
                            Um método completo e 100% validado por milhares de alunos.
                            <br/> Do operacional à gestão de risco.
                        </p>
                    </FadeIn>
                </div>
                ...
                <FadeIn delay={0.1}>
                    <div className="grid lg:grid-cols-[1fr_1.4fr] gap-12 items-stretch mb-24">
                        {/* Left — label + quote */}
                        <div className="flex flex-col justify-between bg-[var(--dark-surface)] border border-[var(--white-10)] rounded-3xl p-10 overflow-hidden relative group hover:border-[var(--gold-premium)]/30 transition-all">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-3 mb-6">
                                    <span className="text-xs font-black tracking-[0.2em] uppercase text-[var(--gold-premium)]">
                                        01
                                    </span>
                                    <div className="h-px flex-1 bg-[var(--gold-premium)]/20" />
                                    <LineChart className="w-5 h-5 text-[var(--gold-premium)]" />
                                </div>
                                <h3 className="font-display font-black text-4xl lg:text-5xl uppercase leading-tight text-white mb-6">
                                    Operacional
                                    <br />
                                    <span className="text-[var(--gold-premium)]">Limpo</span>
                                </h3>
                                ...
                                <div className="space-y-3">
                                    {pillars.map((p, i) => (
                                        <div key={i} className="flex items-center gap-3">
                                            <ChevronRight className="w-4 h-4 text-[var(--gold-premium)] flex-shrink-0" />
                        ...
                        <div className="flex flex-col justify-center bg-gradient-to-br from-[var(--gold-premium)]/12 to-transparent border border-[var(--gold-premium)]/25 rounded-3xl p-10">
                            <div className="mb-8">
                                <span className="font-display font-black text-8xl text-[var(--gold-premium)]/20 leading-none block">
                                    "
                                </span>
                            </div>
                            ...
                            <p className="text-[var(--white-50)] text-sm uppercase tracking-widest font-bold">
                ...
                <FadeIn delay={0.1}>
                    <div className="mb-24">
                        <div className="flex items-center gap-4 mb-10">
                            <span className="text-xs font-black tracking-[0.2em] uppercase text-[var(--gold-premium)]">02</span>
                            <div className="h-px flex-1 max-w-[60px] bg-[var(--gold-premium)]/20" />
                            <h3 className="font-display font-black text-3xl lg:text-4xl uppercase text-white">
                                Fibonacci <span className="text-[var(--gold-premium)]">Descomplicada</span>
                            </h3>
                            <div className="h-px flex-1 bg-[var(--white-10)]" />
                            <Layers className="w-5 h-5 text-[var(--gold-premium)]" />
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                                    ...
                                    <div className="space-y-4">
                                        {[
                                            ...
                                            <div key={i} className="flex items-start gap-3">
                                                <Circle className="w-2 h-2 mt-1.5 text-[var(--gold-premium)] fill-[var(--gold-premium)] flex-shrink-0" />
                                                <span className="text-sm text-[var(--white-70)]">{item}</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                            ...
                            {/* Quote destaque */}
                            <div className="bg-[var(--gold-premium)] rounded-2xl p-8 flex flex-col justify-center">
                                <p className="font-display font-black text-xl lg:text-2xl text-black leading-snug mb-4">
                                    "O preço se movimenta entre mínimas, máximas e 50%. Sempre."
                                </p>
                                <span className="text-black/60 text-xs uppercase font-bold tracking-widest">Regra da Fibonacci</span>
                            </div>

                            {/* Card complementar */}
                            <div className="bg-[var(--dark-elevated)] border border-[var(--white-10)] rounded-2xl p-8 flex flex-col justify-between">
                                <div>
                                    <p className="text-xs font-bold uppercase tracking-widest text-[var(--gold-premium)] mb-4">Além disso</p>
                                    <ul className="space-y-3 mb-6">
                                        {[
                                            ...
                                            <li key={i} className="flex items-start gap-3">
                                                <ChevronRight className="w-4 h-4 text-[var(--gold-premium)] flex-shrink-0 mt-0.5" />
                                                <span className="text-sm text-[var(--white-70)]">{item}</span>
                                            </li>
                                        ))}
                                    </ul>
                                ...
                                <div className="border-t border-[var(--white-10)] pt-5">
                                    <p className="text-[var(--white-50)] text-sm leading-relaxed italic">
                ...
                <FadeIn delay={0.1}>
                    <div className="grid lg:grid-cols-[1.4fr_1fr] gap-12 items-stretch mb-24">
                        {/* Left — content */}
                        <div className="bg-[var(--dark-surface)] border border-[var(--white-10)] rounded-3xl p-10 relative overflow-hidden group hover:border-[var(--green-bull)]/30 transition-all">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-3 mb-6">
                                    <span className="text-xs font-black tracking-[0.2em] uppercase text-[var(--gold-premium)]">03</span>
                                    <div className="h-px flex-1 max-w-[40px] bg-[var(--gold-premium)]/20" />
                        ...
                        <div className="flex flex-col justify-center border border-[var(--green-bull)]/25 bg-[var(--green-bull)]/8 rounded-3xl p-10">
                            ...
                            <p className="text-[var(--white-50)] leading-relaxed text-sm">
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    <span className="text-xs font-black tracking-[0.2em] uppercase text-[var(--gold-premium)]">04</span>
                                    <div className="h-px w-10 bg-[var(--gold-premium)]/20" />
                                    <Zap className="w-5 h-5 text-[var(--gold-premium)]" />
                                </div>
                                <h3 className="font-display font-black text-4xl lg:text-5xl uppercase leading-tight text-white">
                                    Setups <span className="text-[var(--gold-premium)]">Autorais</span>
                                </h3>
                            </div>
                            <p className="text-[var(--white-50)] max-w-sm leading-relaxed md:text-right">
                                Estruturas operacionais desenvolvidas para acelerar o aprendizado dos alunos.
                            </p>
                        </div>

                        <div className="bg-gradient-to-r from-[var(--gold-premium)]/10 to-transparent border border-[var(--gold-premium)]/20 rounded-2xl p-6 mb-8">
                            <p className="font-display font-bold text-lg lg:text-xl text-white">
                                "O mercado é repetitivo…{" "}
                                <span className="text-[var(--gold-premium)]">
                            ...
                            {setups.map((setup, idx) => (
                                <FadeIn key={idx} delay={0.05 * idx}>
                                    <motion.div
                                        ...
                                        className="group relative bg-[var(--dark-surface)] border border-[var(--white-10)] rounded-2xl p-6 overflow-hidden transition-all hover:border-[var(--gold-premium)]/40 hover:shadow-[0_0_30px_rgba(212,175,55,0.12)]"
                                    >
                                        <div className="absolute inset-0 bg-gradient-to-br from-[var(--gold-premium)]/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                                        <div className="absolute top-4 right-4">
                                            <span className="text-xs font-black text-[var(--gold-premium)]/40">
                                                {String(idx + 1).padStart(2, "0")}
                                            </span>
                                        </div>
                                        <div className="relative z-10">
                                            <h4 className="font-display font-bold text-base uppercase text-white mb-2 group-hover:text-[var(--gold-premium)] transition-colors pr-6">
                                                {setup.name}
                                            </h4>
                                            <p className="text-xs text-[var(--white-50)] leading-relaxed">
                                                {setup.description}
                                            </p>
                                        </div>
                                    </motion.div>
                ...
                <FadeIn delay={0.1}>
                    <div className="grid lg:grid-cols-2 gap-8 mb-20">
                        ...
                        {/* 05 Scalps Certeiros */}
                        <div className="bg-[var(--dark-surface)] border border-[var(--white-10)] rounded-3xl p-10 relative overflow-hidden group hover:border-[var(--gold-premium)]/30 transition-all">
                            <div className="absolute bottom-0 right-0 w-64 h-64 bg-[var(--gold-premium)]/5 blur-[80px] rounded-full" />
                            <div className="relative z-10">
                                <div className="flex items-center gap-3 mb-6">
                                    <span className="text-xs font-black tracking-[0.2em] uppercase text-[var(--gold-premium)]">05</span>
                                    <div className="h-px flex-1 max-w-[40px] bg-[var(--gold-premium)]/20" />
                                    <TrendingUp className="w-5 h-5 text-[var(--gold-premium)]" />
                                </div>
                                <h3 className="font-display font-black text-3xl lg:text-4xl uppercase leading-tight text-white mb-4">
                                    Scalps <span className="text-[var(--gold-premium)]">Certeiros</span>
                                </h3>
                                <p className="text-[var(--white-60)] leading-relaxed mb-8">
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    {[
                                        ...
                                        <div key={i} className="text-center border border-[var(--white-10)] rounded-xl p-3">
                                            <p className="font-display font-black text-lg text-[var(--gold-premium)]">{stat.value}</p>
                        ...
                        {/* 06 Gestão de Risco */}
                        <div className="bg-gradient-to-br from-[var(--dark-elevated)] to-[var(--dark-surface)] border border-[var(--white-10)] rounded-3xl p-10 relative overflow-hidden group hover:border-[var(--green-bull)]/30 transition-all">
                            <div className="absolute top-0 left-0 w-64 h-64 bg-[var(--green-bull)]/5 blur-[80px] rounded-full" />
                            <div className="relative z-10">
                                <div className="flex items-center gap-3 mb-6">
                                    <span className="text-xs font-black tracking-[0.2em] uppercase text-[var(--gold-premium)]">06</span>
                                    <div className="h-px flex-1 max-w-[40px] bg-[var(--gold-premium)]/20" />
                                ...
                                <div className="bg-[var(--green-bull)]/10 border border-[var(--green-bull)]/20 rounded-xl px-5 py-4">
                                    <p className="text-sm text-[var(--white-70)] leading-relaxed">
