            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <FadeIn delay={0.1}>
                    <div className="grid lg:grid-cols-[1fr_1.5fr] gap-12 items-stretch mb-24">
                        ...
                        <div className="flex flex-col justify-between bg-gradient-to-br from-[var(--green-bull)]/8 to-transparent border border-[var(--green-border)] rounded-3xl p-6 lg:p-10 overflow-hidden">
                            <div>
                                <div className="flex items-center gap-3 mb-6">
                                ...
                                <h3 className="font-display font-black text-3xl lg:text-4xl uppercase leading-tight text-white mb-6">
                                    Comportamento
                                    <br />
                        ...
                        <div className="bg-[var(--dark-surface)] border border-[var(--white-10)] rounded-3xl p-6 lg:p-10 relative overflow-hidden group hover:border-[var(--green-border)] transition-all">
