...
const reasons = [
    ...
    { title: "Resultados Reais", text: "Alunos evoluindo na leitura e construindo consistência. Resultado vem como consequência do processo bem executado.", icon: Target, colSpan: "col-span-1 lg:col-span-2", bg: "bg-gradient-to-br from-[var(--light-base)] to-white", border: "border-[var(--green-bull)]/20 lg:border-slate-200", glow: "group-hover:shadow-[0_0_40px_rgba(0,191,99,0.10)]" },
    { title: "Mesas Proprietárias", text: "Alto índice de alunos aprovados em mesas proprietárias. Preparação alinhada com o que o mercado exige de verdade.", icon: Award, colSpan: "md:col-span-2 lg:col-span-2", bg: "bg-gradient-to-tr from-[var(--light-base)] to-[var(--light-elevated)] bg-white", border: "border-[var(--green-dark)]/20", glow: "group-hover:shadow-[0_0_40px_rgba(212,175,55,0.15)]" },
    ...
    { title: "Acompanhamento", text: "Acompanhamento diário no grupo exclusivo. Bastidores, análises e direcionamento contínuo.", icon: Users, colSpan: "md:col-span-2 lg:col-span-2", bg: "bg-gradient-to-bl from-[var(--light-surface)] to-[var(--light-base)]", border: "border-slate-200", glow: "group-hover:shadow-[0_0_40px_rgba(0,191,99,0.10)]" }
];
